...
SOURCES=("fineweb_edu","wikipedia","fineweb");TARGET=50_000_000
...
def main():
 ...
 if target>TARGET:raise RuntimeError("controlled DATA-D-v2r1 lineage must not continue past 50M")
 ...
 milestones={1_000_000,3_000_000,5_000_000,7_500_000,10_000_000,15_000_000,20_000_000,25_000_000,35_000_000,50_000_000};evaluated={x for x in milestones if x<=tokens}
 ...
 if tokens!=target or (target==TARGET and source_tokens!={"fineweb_edu":25_000_000,"wikipedia":12_500_000,"fineweb":12_500_000}):raise RuntimeError("exact terminal mixture failure")
